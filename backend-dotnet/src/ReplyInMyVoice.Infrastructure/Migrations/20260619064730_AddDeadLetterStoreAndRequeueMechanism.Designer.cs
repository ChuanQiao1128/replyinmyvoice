...
namespace ReplyInMyVoice.Infrastructure.Migrations
{
    ...
    [Migration("20260619064730_AddDeadLetterStoreAndRequeueMechanism")]
    partial class AddDeadLetterStoreAndRequeueMechanism
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReplyInMyVoice.Domain.Entities.DeadLetterMessage", b =>
                {
                    b.HasOne("ReplyInMyVoice.Domain.Entities.OutboxMessage", "OutboxMessage")
                        .WithMany()
                        .HasForeignKey("OutboxMessageId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ReplyInMyVoice.Domain.Entities.StripeEvent", "StripeEvent")
                        .WithMany()
                        .HasForeignKey("StripeEventId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("OutboxMessage");

                    b.Navigation("StripeEvent");
                });
